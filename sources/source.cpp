...
#define duration 0 //длительность хеширования одного потока в количестве рассчитанных значений
